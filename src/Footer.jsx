    ...
    <footer className="footer">
      <div className="footer-content">
        <div className="footer-info">
          <div className="footer-gym-name">WHITE TIGER MUAY THAI</div>
          <div>711 Avenue E, Stafford, TX 77477</div>
          <div>
            <a href="tel:8325746184" className="footer-main-phone">
              832.574.6184
            </a>
          </div>
          <div className="footer-front-desk">
            Front Desk Phone Number:{" "}
            <a href="tel:2819695908" className="footer-front-desk-phone">
              281-969-5908
            </a>
          </div>
        </div>
        <div className="footer-social">
          <a
            href="https://www.instagram.com/white_tiger_muaythai_/"
            target="_blank"
          ...
          <a
            href="https://www.facebook.com/morgan.oriahi.3/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook"
          >
          ...
          <a
            href="https://www.youtube.com/@WhiteTigerMuayThaiTx"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="YouTube"
          >
